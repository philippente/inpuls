...
class AgentBox2D(Agent):
    ...
    def sample(self, policy, condition, verbose=False, save=True, noisy=True, use_TfController=True, rnd=False):
        """
        ...
        self._worlds[condition].reset_world(rnd)
        ...
        for t in range(self.T):
            ...
            U[t, :] = policy.act(X_t, obs_t, t, noise)
            if (t+1) < self.T:
