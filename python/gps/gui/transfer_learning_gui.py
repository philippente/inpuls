"""
Transfer Learning GUI

The Transfer Learning GUI is used to interact with the GCM algorithm during training.
...
from gps.proto.gps_pb2 import END_EFFECTOR_POINTS, END_EFFECTOR_POSITIONS, END_EFFECTOR_ROTATIONS, \
        JOINT_ANGLES, JOINT_SPACE, TRIAL_ARM
from gps.utility.general_utils import get_ee_points

ROS_ENABLED = False
try:
    import rospkg
    from gps.agent.ros_jaco.ros_utils import TimeoutException
