...
class ArmPlugin: public RobotPlugin
{
protected:
    ...
    KDL::Chain active_arm_fk_chain_;
    // KDL solvers for the end-effectors.
    boost::shared_ptr<KDL::ChainFkSolverPos> active_arm_fk_solver_;
    // KDL solvers for end-effector Jacobians.
    boost::shared_ptr<KDL::ChainJntToJacSolver> active_arm_jac_solver_;
    // Subscribers.
